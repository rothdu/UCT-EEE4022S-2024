...
def plotData():
    ...
    proc_types = ("rd", "cfar", "bf", "ang", "md")
    procs = (processes.rangeDopplerProcessFinal, processes.cfarProcessFinal, processes.beamformingProcessFinal, processes.angleProcessFinal, processes.microDopplerProcessFinal)
